...
curl https://raw.githubusercontent.com/bob16795/mondofied/master/scr/chroot.sh > /mnt/chroot.sh && arch-chroot /mnt bash chroot.sh && rm /mnt/chroot.sh
